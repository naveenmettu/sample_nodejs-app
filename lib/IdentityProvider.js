    ...
    this.options = {
      ...
      getPostURL: (audience, authnRequestDom, req, callback) => {
        if (this.serviceProviders[audience]) {
          ...
          if (req.authnRequest && req.authnRequest.acsUrl && req.authnRequest.acsUrl !== this.serviceProviders[audience].recipient) {
            if (this.serviceProviders[audience].acceptedAcsUrls
